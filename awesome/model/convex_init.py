# Source code is from https://github.com/ml-jku/convex-init/blob/main/convex_init.py
# "Principled Weight Initialisation for Input-Convex Neural Networks"
# By Pieter-Jan Hoedt, Günter Klambauer
...
class TraditionalInitialiser:
    ...
    def compute_parameters(self, fan_in: int, no_bias: bool = False) -> Optional[Tuple[
